...
class contact_us extends CI_Controller {
  ...
  function index() {
    ...
    //JS
    $content['js'][0] = 'js/dashboard/private/contact_us.js';

    $data['content'] = $this->load->view('dashboard/contact_us/index', $content, TRUE);
  ...
  function edit_object() {
    ...
    if ($checkadmin > 0) {
      ...
      $data['result'] = "s";
      $this->model_contact_us->edit_object($content);
