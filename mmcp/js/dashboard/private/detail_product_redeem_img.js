$(document).ready(function () {
  ...
  getObject = function (page)
  {
    ...
    //End Filter
    $.ajax({
      url: baseurl + 'dashboard/detail_product_redeem_img/show_object',
      type: 'POST',
      data:
        {
          page: page,
  ...
  addObject = function ()
  {
    var id_product = $('#id_product').val();
    $.ajax({
      url: baseurl + 'dashboard/detail_product_redeem_img/check_field',
      type: 'POST',
      data:
        {
        },
      ...
      success: function (result) {
        ...
        {
          $.ajaxFileUpload({
            url: baseurl + 'dashboard/detail_product_redeem_img/add_object',
            secureuri: false,
  ...
  editObject = function ()
  {
    ...
    $.ajax({
      ...
      success: function (result) {
        ...
        {
          $.ajaxFileUpload({
            url: baseurl + 'dashboard/detail_product_redeem_img/edit_object',
            secureuri: false,
  ...
  {
    $.ajax({
      url: baseurl + 'dashboard/detail_product_redeem_img/remove_object',
      type: 'POST',
      data:
        {
          id: id
  ...
  setVisible = function ()
  {
    ...
    $.each(id, function (x, val) {
      ...
      $(document).on('click', '#btn_visible' + val, function () {
        $.ajax({
          url: baseurl + 'dashboard/detail_product_redeem_img/set_visible',
          type: 'POST',
          data:
            {
              id: val
  ...
  setEdit = function ()
  {
    ...
    $.each(id, function (x, val) {
      ...
      $(document).on('click', '#btn_edit' + val, function () {
        $.ajax({
          url: baseurl + 'dashboard/detail_product_redeem_img/get_object',
          type: 'POST',
          data:
            {
              id: val
