(function ($) {
    ...
    $.fn.simpleGallery = function (options) {
        ...
        var init = function () {
            ...
            var a = $('<a>').attr('img-lens', lens_image).addClass(opts.parent_anchor_class);
    ...
    $.fn.simpleGallery.defaults = {
        ...
        lens_image_attr: 'img-lens',
        big_image_attr: 'big-img',
...
$(document).ready(function(){
		$('#demo-1 .simpleLens-thumbnails-container img').simpleGallery({
				loading_image: '/images/layout/icons/loading.gif'
		});
