$(document).ready(function () {
  ...
  getObject = function (page)
  {
    ...
    //Filter
    var payment_name = $('#txt_payment_name').val();
    var rek_no = $('#txt_rek_no').val();
    var rek_name = $('#txt_rek_name').val();
    var visible = $('#sel_visible').val();
    var order = $('#sel_order').val();
    //End Filter
    $.ajax({
      url: baseurl + 'dashboard/payment/show_object',
      type: 'POST',
      data:
        {
          page: page,
        ...
        if (result['result'] === 's')
        {
          ...
          for (var x = 0; x < result['total']; x++)
          {
            ...
            <tr>\
              ...
              <td class='tdcenter'>" + result['payment_name'][x] + "</td>\
              <td class='tdcenter'>" + result['rek_no'][x] + "</td>\
              <td class='tdcenter'>" + result['rek_name'][x] + "</td>\
  ...
  addObject = function ()
  {
    var payment_name = $('#txt_addpaymentname').val();
    var rek_no = $('#txt_addrekno').val();
    var rek_name = $('#txt_addrekname').val();
    $.ajax({
      url: baseurl + 'dashboard/payment/check_field',
      type: 'POST',
      data:
        {
          payment_name: payment_name,
      ...
      success: function (result) {
        ...
        {
          $.ajax({
            url: baseurl + 'dashboard/payment/add_object',
            type: 'POST',
            data:
              {
                payment_name: payment_name,
  ...
  editObject = function ()
  {
    ...
    var payment_name = $('#txt_editpaymentname').val();
    var rek_no = $('#txt_editrekno').val();
    var rek_name = $('#txt_editrekname').val();
    $.ajax({
      url: baseurl + 'dashboard/payment/check_field',
      type: 'POST',
      data:
      ...
      success: function (result) {
        ...
        {
          $.ajax({
            url: baseurl + 'dashboard/payment/edit_object',
            type: 'POST',
            data:
              {
                id: id,
  ...
  {
    $.ajax({
      url: baseurl + 'dashboard/payment/remove_object',
      type: 'POST',
      data:
        {
          id: id
  ...
  setVisible = function ()
  {
    ...
    $.each(id, function (x, val) {
      ...
      $(document).on('click', '#btn_visible' + val, function () {
        $.ajax({
          url: baseurl + 'dashboard/payment/set_visible',
          type: 'POST',
          data:
            {
              id: val
  ...
  setEdit = function ()
  {
    ...
    $.each(id, function (x, val) {
      ...
      $(document).on('click', '#btn_edit' + val, function () {
        $.ajax({
          url: baseurl + 'dashboard/payment/get_object',
          type: 'POST',
          data:
            {
              id: val
          ...
          success: function (result) {
            ...
            {
              $("#txteditid").val(val);
              $("#txt_editpaymentname").val(result['payment_name']);
              $("#txt_editrekno").val(result['rek_no']);
              $("#txt_editrekname").val(result['rek_name']);
              $('.modal_warning').hide();
