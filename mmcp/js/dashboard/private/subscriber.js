$(document).ready(function () {
  ...
  getObject = function (page)
  {
    ...
    //End Filter
    $.ajax({
      url: baseurl + 'dashboard/subscriber/show_object',
      type: 'POST',
      data:
        {
          page: page,
  ...
  addObject = function ()
  {
    ...
    $.ajax({
      url: baseurl + 'dashboard/subscriber/check_field',
      type: 'POST',
      data:
        {
          email: email
      ...
      success: function (result) {
        ...
        {
          $.ajax({
            url: baseurl + 'dashboard/subscriber/add_object',
            type: 'POST',
            data:
              {
                email: email
  ...
  editObject = function ()
  {
    ...
    $.ajax({
      ...
      success: function (result) {
        ...
        {
          $.ajax({
            url: baseurl + 'dashboard/subscriber/edit_object',
            type: 'POST',
            data:
              {
                id: id,
  ...
  {
    $.ajax({
      url: baseurl + 'dashboard/subscriber/remove_object',
      type: 'POST',
      data:
        {
          id: id
  ...
  setActive = function ()
  {
    ...
    $.each(id, function (x, val) {
      ...
      $(document).on('click', '#btn_active' + val, function () {
        $.ajax({
          url: baseurl + 'dashboard/subscriber/set_active',
          type: 'POST',
          data:
            {
              id: val
  ...
  setEdit = function ()
  {
    ...
    $.each(id, function (x, val) {
      ...
      $(document).on('click', '#btn_edit' + val, function () {
        $.ajax({
          url: baseurl + 'dashboard/subscriber/get_object',
          type: 'POST',
          data:
            {
              id: val
