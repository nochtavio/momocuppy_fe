                                            ...
                                            <td valign="top">
                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h2 class="h2">Order Confirmation for #876543</h2>
                                                                <br />
                                                                <strong>Dear Angel,</strong> <br /><br />
                                                        ...
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content01">
                                                              <div style="clear:both;float:right;">
                                                              	...
                                                              	<span style="float:left;width:150px;text-align:right;">IDR 90.000</span>                                                              
                                                              </div>
                                                              <div style="clear:both;float:right;">
                                                              ...
                                                              <div style="clear:both;float:right;">
                                                              	...
                                                              	<span style="float:left;width:150px;text-align:right;"><strong>IDR 900.000</strong></span>                                                            
                                                              </div>                                                                                                                                                                                     
                                                    ...
                                                    <tr>
                                                        ...
                                                        Shipping Carrier : <strong>JNE REG</strong>
                                                        </div>
                                                      </td>
                                                    </tr>
                                                          ...
                                                          <table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
                                                              ...
                                                              <tr mc:repeatable>
                                                                  <td valign="top" class="dataTableContent" mc:edit="data_table_content00" style="font-weight:normal;line-height:120%;">
                                                                  	<strong>ANGELINE KRISTIALI</strong><br  />
                                                                    Kavling Polri Blok A 10 no. 57, Jelambar<br  />
                                                                    Jakarta 11460<br  />
                                                                    Indonesia<br />
                                                                    08123456789<br />
                                                                    angel@yahoo.com
                                                    ...
                                                    <tr>
                                                    	<td>
                                                          ...
                                                          <ul>
                                                          	<li style="font-weight:bold;">BCA / Ryan / 0690201283</li>
                                                            <li style="font-weight:bold;">Mandiri / Ryan / 0690201283</li>
                                                          </ul>
                                                          ...
                                                          After you made payment, kindly apprise us of your transaction details <a href="#" style="color:#f16170;">here</a>
                                                          <br /><br />
