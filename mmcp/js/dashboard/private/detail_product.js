$(document).ready(function () {
  ...
  getObject = function (page)
  {
    ...
    //Filter
    var id_color = $('#sel_id_color').val();
    var visible = $('#sel_visible').val();
    var order = $('#sel_order').val();
    //End Filter
    $.ajax({
      url: baseurl + 'dashboard/detail_product/show_object',
      type: 'POST',
      data:
        {
          page: page,
  ...
  {
    var id_product = $('#id_product').val();
    var id_color = $('#txt_addselcolor').val();
    var stock = $('#txt_addstock').val();
    $.ajax({
      url: baseurl + 'dashboard/detail_product/check_field',
      type: 'POST',
      data:
        {
          id_product: id_product,
      ...
      success: function (result) {
        ...
        {
          $.ajax({
            url: baseurl + 'dashboard/detail_product/add_object',
            type: 'POST',
            data:
              {
                id_product: id_product,
  ...
  editObject = function ()
  {
    ...
    $.ajax({
      ...
      success: function (result) {
        ...
        {
          $.ajax({
            url: baseurl + 'dashboard/detail_product/edit_object',
            type: 'POST',
            data:
              {
                id: id,
  ...
  {
    $.ajax({
      url: baseurl + 'dashboard/detail_product/remove_object',
      type: 'POST',
      data:
        {
          id: id
  ...
  setVisible = function ()
  {
    ...
    $.each(id, function (x, val) {
      ...
      $(document).on('click', '#btn_visible' + val, function () {
        $.ajax({
          url: baseurl + 'dashboard/detail_product/set_visible',
          type: 'POST',
          data:
            {
              id: val
  ...
  setEdit = function ()
  {
    ...
    $.each(id, function (x, val) {
      ...
      $(document).on('click', '#btn_edit' + val, function () {
        $.ajax({
          url: baseurl + 'dashboard/detail_product/get_object',
          type: 'POST',
          data:
            {
              id: val
