  ...
  <div class="col-lg-12">
    <form class="form-inline form_filter" role="form">
      <div class="form-group">
        <label class="sr-only" for="txt_title">Title</label>
        <input type="text" class="form-control" id="txt_title" placeholder="Title">
      </div>
      <div class="form-group">
      ...
      <button id="btn_add" type="button" class="btn btn-primary pull-right">Add Newsletter</button>
