  ...
  <div class="col-lg-12">
    <form class="form-inline form_filter" role="form">
      <div class="form-group">
        <label class="sr-only" for="txt_payment_name">Payment Name</label>
        <input type="text" class="form-control" id="txt_payment_name" placeholder="Payment Name">
      </div>
      <div class="form-group">
        <label class="sr-only" for="txt_rek_no">Rek No</label>
        <input type="text" class="form-control" id="txt_rek_no" placeholder="Rek No">
      </div>
      <div class="form-group">
        <label class="sr-only" for="txt_rek_name">Rek Name</label>
        <input type="text" class="form-control" id="txt_rek_name" placeholder="Rek Name">
      </div>
    ...
    <form class="form-inline form_filter" role="form">
      <div class="form-group">
        <select class="form-control" id="sel_order">
          <option value="-1">Sort By Payment Name A-Z</option>
          <option value="1">Sort By Payment Name Z-A</option>
      ...
      <button id="btn_add" type="button" class="btn btn-primary pull-right">Add Payment</button>
      <div class="cleardiv"></div>
    </form>
  </div>
</div>
